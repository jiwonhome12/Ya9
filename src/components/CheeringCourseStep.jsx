...
export default function CheeringCourseStep({ onBack, onNavigate, savedBlogs = [], onToggleBlog }) {
    ...
    <div className="main-layout">
      ...
      <div className="top-bar" style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', position: 'absolute', right: '16px' }}>
          <button
            onClick={() => onToggleBlog('b1')}
            style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', padding: '4px' }}
          >
            <Bookmark 
              size={20} 
              color="var(--primary-color)" 
              fill={savedBlogs.includes('b1') ? 'var(--primary-color)' : 'none'} 
            />
          </button>
          <Share2 
      ...
      <div className="main-content scrollable">
        <div className="blog-header">
          <h1 className="blog-title">oo야구장 꿀팁 궁금하지 않아?</h1>
          <h2 className="blog-subtitle">초보 직관러, 첫 직관,,,</h2>
        </div>

        <div className="blog-main-image" style={{ backgroundColor: '#DCDCDC', height: '180px', margin: '20px 0', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
